	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header bg-teal-300">
				...
				<h5 class="modal-title">Detil Register Inspeksi Kesehatan Lingkungan Tempat Umum # <?= $dMaster->IdKesTtu ?></h5>
			</div>
						...
						<div class="tab-pane active" id="dataInspeksi">
							<div class="row">
								<div class="col-md-12">
									...
									<label class="control-label col-md-7"><?= date_format(date_create($dMaster->TglKesTtu), 'd F Y') ?></label>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-md-12">
									<label class="control-label col-md-3">Kategori Tempat Umum</label>
									<label class="control-label col-md-1">:</label>
									<label class="control-label col-md-7"><?= $dMaster->KategoriTtu ?></label>
								</div>
							</div>
							<hr style="margin-top:5px;margin-bottom:5px;" />
							<div class="row">
								<div class="col-md-12">
									<label class="control-label col-md-3">Nama Tempat Umum</label>
									<label class="control-label col-md-1">:</label>
									<label class="control-label col-md-7"><?= $dMaster->NamaTempatUmum ?></label>
								</div>
							</div>
							<hr style="margin-top:5px;margin-bottom:5px;" />
							<div class="row">
								<div class="col-md-12">
									<label class="control-label col-md-3">JML Terdapat</label>
									<label class="control-label col-md-1">:</label>
									<label class="control-label col-md-7"><?= $dMaster->JumlahTtu ?></label>
								</div>
							</div>
							<hr style="margin-top:5px;margin-bottom:5px;" />
							<div class="row">
								<div class="col-md-12">
									<label class="control-label col-md-3">JML Diperiksa</label>
									<label class="control-label col-md-1">:</label>
									<label class="control-label col-md-7"><?= $dMaster->JumlahDiperiksa ?></label>
								</div>
							</div>
							<hr style="margin-top:5px;margin-bottom:5px;" />
							<div class="row">
